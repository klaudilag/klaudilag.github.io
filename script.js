$(document).ready(function() {
  const apiRoot = 'https://kodillamanyprojects2.klaudiuszlagodz.repl.co/v1/tasks';
  const trelloApiRoot = 'https://kodillamanyprojects2.klaudiuszlagodz.repl.co/v1/trello';
